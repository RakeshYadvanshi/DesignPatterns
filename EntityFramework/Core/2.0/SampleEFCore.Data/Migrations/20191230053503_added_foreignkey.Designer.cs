...
namespace SampleEFCore.Data.Migrations
{
    ...
    [Migration("20191230053503_added_foreignkey")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SampleEF.Domain.SamuraiLiving", b =>
                {
                    ...
                    b.Property<int>("Samurai");

                    b.HasKey("Living", "Samurai");
            ...
            modelBuilder.Entity("SampleEF.Domain.SamuraiLiving", b =>
                {
                    b.HasOne("SampleEF.Domain.SamuraiLivingDetail")
                        .WithMany()
                        .HasForeignKey("Living")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("SampleEF.Domain.Samurai")
                        .WithMany()
